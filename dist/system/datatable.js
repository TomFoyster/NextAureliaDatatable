...
System.register(["aurelia-framework"], function (_export, _context) {
  ...
  var bindable, inject, customElement, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, Datatable;
  ...
  return {
    ...
    execute: function () {
      _export("Datatable", Datatable = (_dec = inject(Element), _dec(_class = (_class2 = function () {
        function Datatable() {
